...
Mat readFaces(int noOfFaces, vector<string>& loadedFaceID)
{
    ...
    string facesDataPath = "c:/Users/Dumah/Desktop/Proyect/FaceRecognition_PCA/FRG/data/facesdata.txt";
...
Mat readMean()
{
    ...
    string meanPath = "c:/Users/Dumah/Desktop/Proyect/FaceRecognition_PCA/FRG/data/mean.txt";
...
Mat readEigen(int noOfFaces)
{
    ...
    string eigenPath = "c:/Users/Dumah/Desktop/Proyect/FaceRecognition_PCA/FRG/data/eigen.txt";
